...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/davidnovotny/Desktop/pumplo/.claude
                  → checks /Users/davidnovotny/Desktop/pumplo/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/davidnovotny/Desktop/pumplo/.claude/get-shit-done
                  → writes to /Users/davidnovotny/Desktop/pumplo/.claude/get-shit-done/hooks/
...
```bash
INIT=$(node "/Users/davidnovotny/Desktop/pumplo/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/davidnovotny/Desktop/pumplo/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/davidnovotny/Desktop/pumplo/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
