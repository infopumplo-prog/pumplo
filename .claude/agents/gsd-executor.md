...
**See @/Users/davidnovotny/Desktop/pumplo/.claude/get-shit-done/references/checkpoints.md**
...
```bash
node /Users/davidnovotny/Desktop/pumplo/.claude/get-shit-done/bin/gsd-tools.cjs commit-to-subrepo "{type}({phase}-{plan}): {concise task description}" --files file1 file2 ...
```
...
**Use template:** @/Users/davidnovotny/Desktop/pumplo/.claude/get-shit-done/templates/summary.md
...
node "/Users/davidnovotny/Desktop/pumplo/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap update-plan-progress "${PHASE_NUMBER}"
...
```bash
node "/Users/davidnovotny/Desktop/pumplo/.claude/get-shit-done/bin/gsd-tools.cjs" state add-blocker "Blocker description"
```
</state_updates>
