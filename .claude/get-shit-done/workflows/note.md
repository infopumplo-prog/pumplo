...
- **Global scope**: `/Users/davidnovotny/Desktop/pumplo/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/davidnovotny/Desktop/pumplo/.claude/notes/`)
...
2. Glob `/Users/davidnovotny/Desktop/pumplo/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/davidnovotny/Desktop/pumplo/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/davidnovotny/Desktop/pumplo/.claude/notes/` — works in any directory
