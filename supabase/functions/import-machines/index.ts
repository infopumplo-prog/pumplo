...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log(`User ${userId} attempting to import machines`);
    ...
    console.log(`Admin ${userId} authorized for machine import`);
    ...
    console.log(`Successfully imported ${machines.length} machines by admin ${userId}`);
